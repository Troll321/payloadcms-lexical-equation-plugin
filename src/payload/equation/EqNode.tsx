...
import type { DOMConversionMap, DOMConversionOutput, DOMExportOutput, EditorConfig, LexicalNode, NodeKey, SerializedLexicalNode, Spread } from "@payloadcms/richtext-lexical/lexical";
...
const EquationComponent = React.lazy(() => import("./EqComponents"));
